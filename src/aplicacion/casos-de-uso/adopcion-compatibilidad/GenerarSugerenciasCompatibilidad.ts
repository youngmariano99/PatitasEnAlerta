...
> {
  constructor(
    ...
    @inject('IRepositorioSugerenciasCompatibilidad')
    private readonly repositorioSugerencias: IRepositorioSugerenciasCompatibilidad,
    @inject('IEstrategiaCompatibilidad')
    private readonly estrategiaCompatibilidad: IEstrategiaCompatibilidad,
  ) {
    super();
  }

  protected validar(
    input: ComandoGenerarSugerenciasCompatibilidad,
  ): ComandoGenerarSugerenciasCompatibilidad {
    return input;
  }
  ...
  protected async persistir(
    dato: ComandoGenerarSugerenciasCompatibilidad,
  ): Promise<SugerenciaCompatibilidadDto[]> {
