    ...
    actualizar: jest.fn().mockImplementation(async (id: string, cambios: CambiosFichaAdopcion) =>
      FichaAdopcion.reconstruir(
        id,
        {
          ...
          compatibleOtrosAnimales: cambios.compatibleOtrosAnimales ?? fichaExistente.compatibleOtrosAnimales,
          necesidadesMedicasDetalle: cambios.necesidadesMedicasDetalle ?? fichaExistente.necesidadesMedicasDetalle,
        },
