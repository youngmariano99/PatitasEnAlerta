 ...
 */
@injectable()
export class ObtenerCuestionarioPropio extends CasoDeUsoBase<ComandoObtenerCuestionarioPropio, CuestionarioAdoptanteDto> {
  constructor(
  ...
  protected async persistir(dato: ComandoObtenerCuestionarioPropio): Promise<CuestionarioAdoptanteDto> {
