...
function crearCuestionario(overrides?: Partial<DatosCuestionarioAdoptante>): DatosCuestionarioAdoptante {
  return {
...
describe('CompatibilidadPorReglas', () => {
  ...
  it('sin niños en casa, cualquier compatibleNinos coincide (no descarta)', () => {
    ...
    const score = estrategia.calcularScore(cuestionario, { nivelEnergia: 'alto', compatibleNinos: false, compatibleOtrosAnimales: null });
  ...
  it('2 horas solo o menos no restringe por nivel de energía', () => {
    ...
    const score = estrategia.calcularScore(cuestionario, { nivelEnergia: 'alto', compatibleNinos: null, compatibleOtrosAnimales: null });
  ...
  it('entre 2 y 6 horas solo, energía media también coincide (no exige "bajo")', () => {
    ...
    const score = estrategia.calcularScore(cuestionario, { nivelEnergia: 'medio', compatibleNinos: null, compatibleOtrosAnimales: null });
  ...
  it('un dato no declarado (null) en cualquiera de los dos lados no penaliza', () => {
    ...
    const score = estrategia.calcularScore(cuestionario, { nivelEnergia: null, compatibleNinos: null, compatibleOtrosAnimales: null });
