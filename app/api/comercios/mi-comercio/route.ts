...
/**
 * Comercio propio del usuario autenticado, o `null` si todavía no registró
 * ninguno — usado por la interfaz para decidir entre mostrar el alta o el
 * panel de catálogo (Módulo 7).
 */
export async function GET(request: NextRequest) {
  ...
  try {
    const casoDeUso = container.resolve(ObtenerComercioPropio);
    ...
    logger.error({ err: error }, 'Error no controlado en GET /api/comercios/mi-comercio');
